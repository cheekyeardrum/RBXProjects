...
local function createTab(name, emoji)
    ...
    btn.Text = (" %s   %s"):format(emoji or "•", name)
    round(btn, 8)
...
local autoPage = createTab("Auto", "⚙️")
...
footer.Text = "Cheeky Hub V1.0 — Advanced Animated Edition • Stealthy & Universal"
footer.TextXAlignment = Enum.TextXAlignment.Left

-- ensure glow size tracks main
...
print("Cheeky Hub V1.0 - Advanced Animated Edition loaded.")
